...
<nav id="sidebar" class='mx-lt-5 bg-red' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=Equipments" class="nav-item nav-Equipments"><span class='icon-field'><i class="fa fa-th-list"></i></span> Equipments</a>
				<a href="index.php?page=Attendance" class="nav-item nav-Equipments"><span class='icon-field'><i class="fa fa-th-list"></i></span> Attendance</a>
			<?php endif; ?>
		</div>
